...
- [Use catalog nodes in roles and player grants](/reference/in-game-permissions/administration)
- [Configure a runtime to register the manifest](/reference/in-game-permissions/runtime-integration)
