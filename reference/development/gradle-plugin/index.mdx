...
1. [Install the plugins](/reference/development/gradle-plugin/usage) in your project
...
- Relocates `com.google.protobuf` to `gg.grounds.shaded.protobuf` in final shaded plugin jars so server-bundled protobuf runtimes do not conflict with plugin-generated protobuf classes
