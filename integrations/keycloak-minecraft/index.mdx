...
<Card title="Installation" icon="download" href="/integrations/keycloak-minecraft/installation">
  Install the provider JAR into Keycloak and configure the required Microsoft app registration.
</Card>

<Card title="Configuration" icon="sliders" href="/integrations/keycloak-minecraft/configuration">
