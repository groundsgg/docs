...
<Note>
Platform pages document infrastructure building blocks and integrations that support the wider system. Minecraft runtime plugins are documented separately under [Plugins](/reference/plugins).
</Note>
